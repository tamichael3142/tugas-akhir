...
import { MdDashboard, MdEventAvailable, MdReportProblem, MdSchedule, MdSportsSoccer } from 'react-icons/md'
...
export const guruNavs: SidebarItemProps[] = [
  ...
  { icon: <MdEventAvailable />, label: 'Manage Attendance', href: AppNav.guru.manageAbsensi() },
