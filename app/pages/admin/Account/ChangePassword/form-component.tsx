...
import { AdminAccountChangePasswordFormType } from './form'
import { FaEye, FaEyeSlash } from 'react-icons/fa'

export default function AdminAccountSelfUpdateFormComponent() {
  const [passwordVisible, setPasswordVisible] = useState<boolean>(false)
  const [passwordConfirmationVisible, setPasswordConfirmationVisible] = useState<boolean>(false)

  const formHook = useRemixFormContext<AdminAccountChangePasswordFormType>()
