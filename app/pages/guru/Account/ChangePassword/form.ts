...
export type GuruAccountChangePasswordFormType = z.infer<typeof validationSchema>

export const resolver = zodResolver(validationSchema)

export const emptyUserValue: GuruAccountChangePasswordFormType = {
  password: '',
  passwordVerification: '',
}

export const defaultValues: GuruAccountChangePasswordFormType = emptyUserValue
