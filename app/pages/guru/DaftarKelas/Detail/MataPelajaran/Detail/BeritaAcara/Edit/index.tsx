...
const sectionPrefix = 'guru-daftar-kelas-detail-mata-pelajaran-detail-berita-acara-edit'

export default function GuruDaftarKelasDetailMataPelajaranDetailBeritaAcaraEditPage() {
  const loader = useLoaderData<LoaderDataGuruDaftarKelasDetailMataPelajaranDetailBeritaAcaraEdit>()
  const revalidator = useRevalidator()
  const actionData = useActionData<ActionDataGuruDaftarKelasDetailMataPelajaranDetailBeritaAcaraEdit>()
  ...
  function resetForm() {
    formHook.reset(translateRawToFormData(loader.beritaAcara))
  }

  useEffect(() => {
    if (loader.mataPelajaran && loader.beritaAcara) resetForm()
        ...
        <div className='p-4 lg:px-8'>
          ...
          <RemixFormProvider key={`${sectionPrefix}-form`} {...formHook}>
            <AdminDaftarKelasDetailMataPelajaranDetailBeritaAcaraFormComponent
              beritaAcara={loader.beritaAcara}
              days={loader.days}
              hours={loader.hours}
              kelas={loader.kelas}
