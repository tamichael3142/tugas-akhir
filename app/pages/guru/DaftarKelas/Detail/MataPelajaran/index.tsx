...
import GuruDaftarKelasDetailTab, { GuruDaftarKelasDetailTabProps, TabKey } from '../_components/Tab'
...
export default function GuruDaftarKelasDetailMataPelajaranPage() {
  ...
  return (
    <Card className='!p-0 mt-4 lg:mt-8'>
      <GuruDaftarKelasDetailTab
        kelas={loader.kelas as GuruDaftarKelasDetailTabProps['kelas']}
