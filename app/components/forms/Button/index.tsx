    ...
    <button
      ...
      className={classNames(
        ...
        'disabled:cursor-not-allowed',
        {
          ...
          ['bg-neutral-100 text-neutral-600 hover:bg-neutral-200']: color === 'default' && variant === 'contained',
          ...
          ['border-1 border-neutral-200 text-text-neutral-600 hover:bg-neutral-200']:
          ...
          ['disabled:border-gray-400 disabled:bg-gray-300 disabled:text-gray-400 disabled:opacity-80']:
            variant === 'outlined',
          ['text-neutral-600 hover:bg-neutral-200']: color === 'default' && variant === 'text',
