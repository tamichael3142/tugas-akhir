...
import SiswaKelasDetailPage from '~/pages/siswa/Kelas/Detail'
...
export async function loader({ request, params }: LoaderFunctionArgs): Promise<LoaderDataSiswaKelasDetail> {
  ...
  return { kelas, siswaPerKelasPerSemesters } as LoaderDataSiswaKelasDetail
}

export default function SiswaKelasDetailRoute() {
  return <SiswaKelasDetailPage />
}
