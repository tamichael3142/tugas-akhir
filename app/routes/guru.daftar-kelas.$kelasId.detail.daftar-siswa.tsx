...
import GuruDaftarKelasDetailDaftarSiswaPage from '~/pages/guru/DaftarKelas/Detail/DaftarSiswa'
...
export async function loader({
  request,
  params,
}: LoaderFunctionArgs): Promise<LoaderDataGuruDaftarKelasDetailDaftarSiswa> {
  ...
  return { kelas, siswaPerKelasPerSemesters } as LoaderDataGuruDaftarKelasDetailDaftarSiswa
}

export default function GuruDaftarKelasDetailDaftarSiswaRoute() {
  return <GuruDaftarKelasDetailDaftarSiswaPage />
}
